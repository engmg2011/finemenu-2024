...
namespace App\Repository\Eloquent\Itemable\Restaurant;


use App\Models\Items\Restaurant\RestaurantProduct;
...
class RestaurantProductRepository extends BaseRepository implements RestaurantProductRepositoryInterface
{

    public function __construct(RestaurantProduct $model, private readonly FeatureRepositoryInterface $featureRepository)
    {
