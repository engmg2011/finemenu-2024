...
use App\Models\Items\Influencer\InfluencerService;
use App\Models\User;
...
class InfluencerServiceRepository extends BaseRepository implements InfluencerServiceRepositoryInterface
{

    public function __construct(InfluencerService $model, private readonly FeatureRepositoryInterface $featureRepository)
    {
